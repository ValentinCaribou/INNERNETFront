...
import { cyan600, pink600, purple600, orange500 } from "material-ui/styles/colors";
import Download from "material-ui/svg-icons/file/file-download";
import Video from "material-ui/svg-icons/av/movie";
import Nav from "material-ui/svg-icons/social/public";
...
const data = {
  menus: [
    ...
    { text: "A propos", icon: <Web />, link: "/about" },
  ],
  signOut:
    { text: "Déconnexion", icon: <SettingsPower />, link: "/login" },
  signOutMenus: [
  ...
  dashBoardPage: {
    ...
    browserUsage: [
      { name: "Téléchargement", value: 800, color: cyan600, icon: <Download /> },
      { name: "Vidéo", value: 500, color: pink600, icon: <Video /> },
      { name: "Navigation", value: 300, color: orange500, icon: <Nav /> },
      { name: "Réseaux sociaux", value: 300, color: purple600, icon: <Social /> }
    ],
    lineBarChart: [
